...
public:
  ...
  /**
   * @brief Select the request-owned costmap for lazy obstacle heuristic expansion
   * @param costmap Costmap whose lifetime covers the planning request
   */
  static void setObstacleHeuristicCostmap(nav2_costmap_2d::Costmap2D * costmap)
  {
    obstacle_heuristic_costmap = costmap;
  }
  ...
  {
    obstacle_heuristic_costmap = nullptr;
  }
  ...
  static nav2_costmap_2d::Costmap2D * obstacle_heuristic_costmap;
